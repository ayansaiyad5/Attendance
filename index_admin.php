...
body {
  background-color: #00BFFF;
    ...
    <div class="container mt-5 m-auto d-flex flex-column align-items-center">
        <h1>Attedance Management System</h1>
    <h4 class="mt-5 mb-4">ADMIN LOGIN PAGE</h4>
    <form method="POST">
      <div class="mb-3 mt-3">
          ...
          <form method="POST">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input name="key" type="text" class="form-control" id="key" name="key">
              </div>

              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Name:</label>
                <input name="uname" type="text" class="form-control" id="name" name="name">
              </div>
              ...
              <div class="mb-3">
                ...
                <input name="upass" type="password" class="form-control" id="pass" name="pass">
              ...
              <div class="mb-3">
                ...
                <input name='uexp' type="text" class="form-control" id="Experience" name="Experience">
              </div>
              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Email:</label>
                <input name="uemail" type="email" class="form-control" id="Email" name="Email">
              </div>

              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Phone:</label>
                <input name="uphone" type="number" class="form-control" id="phone" name="Phone">
              </div>
    ...
    <p class="mt-4 text-muted text-center">&copy; 2023</p>
